...
function Footer() {
  return ( 
      ...
      <div id="enroll" className=" bg-[#073346] text-Sa px-4 sm:px-8 2xl:px-12  pt-10 pb-20  text-white text-[16px] sm:text-[20px] 2xl:text-[24px]  font-normal sm:flex justify-start items-start overflow-ellipsis space-y-10 sm:space-y-0">
        <div className='space-y-3  space-x-3 sm:w-1/4' >
           <h2 className='font-AK text-[36px]'>Hisimi</h2>
          <p className="">Reach out to us on any of our social media networks</p>
          <div className='flex space-x-3 sm:space-x-1 md:space-x-3 lg:pr-3 items-center'>
            {[1,5,6,3,4].map((icon)=>
        ...
        <div className="  sm:w-1/4 space-y-3 lg:pr-3">
          ...
          <div><a href="#courses">Our Score Board</a></div>
        ...
        <div className='flex '>
          ...
          <button className=" w-1/4 sm:w-2/4 lg:w-2/5 px-4 sm:px-3 lg:px-5 py-2  2xl:py-4 rounded-r-md hover:brightness-75 hover:shadow-2xl bg-[#007db3] text-white text-[10px] sm:text-[12px] 2xl:text-[16px] font-bold ">Send Message</button>
        </div>
